...
int main() {
	...
	printf("a的地址为 %p\n", &a);//&a取出a的地址
	//有一种变量是用来存放地址的 ---- 指针变量
	int* p = &a;//在内存中开辟一块新的空间 名为p 存放a的地址 int* 为p的类型 p是指针变量
	printf("a的地址为 %p\n", &a);
...
![初识指针](https://github.com/HeartWardrum/MyImageHost/blob/88c3c4fe157abc498dfcb2de96a7ef5a2c96c7e6/%E5%88%9D%E8%AF%86%E6%8C%87%E9%92%88.png?raw=true)
